...
---------------]])
    ...
    if msg.sender_user_id_ == 334262610 then
    ...
    if database:get("bot:viewget" .. msg.sender_user_id_) then
      if not msg.forward_info_ then
        ...
        if database:get("lang:gp:" .. msg.chat_id_) then
          ...
          send(msg.chat_id_, msg.id_, 1, "✯↓ عدد المشاهدات  :` " .. msg.views_ .. " `", 1, "md")
        end
        database:del("bot:viewget" .. msg.sender_user_id_)
      end
    end
...
If You No Longer Want To Filter a Word, Send The /done Command !]], 1, "md")
        ...
        if database:get("bot:group:link" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) and (msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "▫️↓  تم ✅ حفظ الرابط🎈", 1, "md")
          end
        ...
        if database:get("rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "▫️↓  تم حفظ القوانين 🎋",  1, "md")
          end
...
> <b>Phone Number</b> : ]] .. phonenumbere, 1, "html")
        ...
        if database:get("bot:nerkh" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "◀ تم وضع سعر البوت ♩", 1, "md")
          end
        end
        if not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Pp]ing$") or text:match("^اونلاين$")) then
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "- البوت اصبح اونلان✞", 1, "md")
          end
        end
        ...
        if is_admin(msg.sender_user_id_) and (text:match("^[Gg]plist$") or text:match("^المجموعات$")) then
...
[]] .. expire .. [[
          ...
          local getproen = function(extra, result)
            ...
            if database:get("getidstatus" .. msg.chat_id_) == "Photo" then
              if result.photos_[0] then
                if database:get("lang:gp:" .. msg.chat_id_) then
                  ...
                  sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_, "✸ الايدي : " .. msg.sender_user_id_, msg.id_, msg.id_)
                end
              elseif database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "* You don't have Profile photo* ❗️\n\n✸ Your Name : " .. name .. "\n✸ Your ID : " .. msg.sender_user_id_, 1, "md")
              else
            ...
            if database:get("getidstatus" .. msg.chat_id_) == "Simple" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "✸ الايدي : " .. msg.sender_user_id_, 1, "md")
              end
            end
          ...
          if status[2] == "active" or status[2] == "فعال" then
            if database:get("getpro:" .. msg.chat_id_) == "Active" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "🚦↓   جلب الصور مفعل 🏌️", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
          ...
          if status[2] == "deactive" or status[2] == "معطل" then
            if database:get("getpro:" .. msg.chat_id_) == "Deactive" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "🚦↓ جلب الصور معطل 🛰️", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            local gproen = function(extra, result)
              if not is_momod(msg.sender_user_id_, msg.chat_id_) and database:get("getpro:" .. msg.chat_id_) == "Deactive" then
                if database:get("lang:gp:" .. msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, "🚦↓ جلب الصور معطل ", 1, "md")
                end
        ...
        local text = msg.content_.text_:gsub("ضع التكرار", "Setflood")
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ss]etflood (%d+)$") and check_user_channel(msg) then
          ...
          if 2 > tonumber(floodmax[2]) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "�⇣  يمكنك وضع تكرار من 2 فصاعداً🎈", 1, "md")
            end
          else
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "�⇣  Flood Sensitivity Change to `" .. floodmax[2] .. "` 🎏", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "�⇣  تم وضع التكرار الى  " .. floodmax[2] .. "* 🎏", 1, "md")
            end
          ...
          if status[2] == "photo" or status[2] == "بالصوره" then
            if database:get("getidstatus" .. msg.chat_id_) == "Photo" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "◀ تم تفعيل الايدي بالصور عزيزي🎐", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
          ...
          if status[2] == "simple" or status[2] == "بالعدد" then
            if database:get("getidstatus" .. msg.chat_id_) == "Simple" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "◀ تم تفعيل الايدي بالعدد♩ ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
        ...
        local text = msg.content_.text_:gsub("اضهار الرقم", "Showphonestatus")
          ...
          if status[2] == "active" or status[2] == "مفعل" then
            if database:get("sharecont" .. msg.chat_id_) == "On" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "• تم تفعيل اظهار الرقم ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "🚦↓  Get Phone Numberhas been *Actived* 📍 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "• تم تفعيل اضهار الرقم ", 1, "md")
              end
          ...
          if status[2] == "deactive" or status[2] == "معطل" then
            if database:get("sharecont" .. msg.chat_id_) == "Off" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "• تم تعطيل اضهار الرقم ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
        ...
        if is_sudo(msg) then
          ...
          if text:match("^[Ss]avephone (.*)$") then
            ...
            if status[2] == "off" or status[2] == "معطل" then
              if database:get("savecont") == "Off" then
                if database:get("lang:gp:" .. msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "◎ Save Phone Number is *Already* Deactive ❗️", 1, "md")
                else
                  send(msg.chat_id_, msg.id_, 1, "◎↲ تم تعطيل حفظ الرقم†", 1, "md")
                end
              else
                if database:get("lang:gp:" .. msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "◎ Save Phone Number has been *Deactived* ❗️", 1, "md")
                else
                  send(msg.chat_id_, msg.id_, 1, "◎↲ تم تعطيل حفظ الرقم† ", 1, "md")
                end
        ...
        local text = msg.content_.text_:gsub("الكليشه", "Clerk")
        if is_sudo(msg) and text:match("^[Cc]lerk (.*)$") then
          local status = {
            string.match(text, "^([Cc]lerk) (.*)$")
          }
          if status[2] == "مفعله" or status[2] == "on" then
            if database:get("clerk") == "On" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "🔅↓  Clerk is *Now Active* 🎈 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "🔅↓  اضهار الكليشه مفعله❗️", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "🔅↓  Clerk Has Been *Actived* 🎈 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "🔅↓  اضهار الكليشه مفعله", 1, "md")
              end
              database:set("clerk", "On")
            end
          end
          if status[2] == "معطله" or status[2] == "off" then
            if database:get("clerk") == "Off" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "💡 Clerk Is *now Deactive* 💡", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "🔅↓  اضهار الكليشه معطل❗️", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
        ...
        local text = msg.content_.text_:gsub("مميزات البوت", "Fun")
          ...
          if status[2] == "مفعله" or status[2] == "on" then
            if database:get("fun") == "On" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "● ◄  تم تفعيل المميزات الجديده 🎌  ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
          ...
          if status[2] == "معطله" or status[2] == "off" then
            if database:get("fun") == "Off" then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "● ◄  تم تعطيل المميزات الجديده 🎌 ", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "🚦↓  Auto leave has been *Deactived* !", 1, "md")
        ...
        if is_sudo(msg) then
          ...
          if text:match("^[Ss]etnerkh$") or text:match("^وضع مذكره$") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "※  Plese Send your *Bot Price* now 🎣 ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "◎↲  ارسل لي المذكره الان⚜️", 1, "md")
            end
        ...
        if is_admin(msg.sender_user_id_) then
          ...
          if text:match("^[Nn]erkh$") or text:match("^المذكره$") then
            ...
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "✺ لم يتم وضع المذكره✞", 1, "md")
            end
          end
        end
        if is_leader(msg) then
          local text = msg.content_.text_:gsub("الدخول عبر الرابط", "Joinbylink")
          if text:match("^[Jj]oinbylink (.*)$") then
            ...
            if status[2] == "مفعل" or status[2] == "on" then
              if database:get("joinbylink") == "On" then
                if database:get("lang:gp:" .. msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, "🔅↓ تم تفعيل الدخول عبر الرابط❗️", 1, "md")
                end
              else
                if database:get("lang:gp:" .. msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "✸ Join by link has been *Actived* ✞", 1, "md")
                else
                  send(msg.chat_id_, msg.id_, 1, "🔅↓  تم تفعيل الدخول عبر الرابط", 1, "md")
                end
            ...
            if status[2] == "معطل" or status[2] == "off" then
              if database:get("joinbylink") == "Off" then
                if database:get("lang:gp:" .. msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "✸ Join by link is *now Deactive* ❗️", 1, "md")
                else
                  send(msg.chat_id_, msg.id_, 1, "🔅↓ تم تعطيل الدخول عبر الرابط✞", 1, "md")
                end
              else
                if database:get("lang:gp:" .. msg.chat_id_) then
                  send(msg.chat_id_, msg.id_, 1, "✸ Join by link has been *Deactived* ♩", 1, "md")
                else
                  send(msg.chat_id_, msg.id_, 1, "🔅↓ تم تعطيل الدخول عبر الرابط❗️", 1, "md")
                end
        ...
        if is_sudo(msg) and (text:match("^[Ss]etsupport$") or text:match("^ضع رابط الدعم$")) then
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "▪️↓  Please Send your *Support link* Or *Support Bot ID* now 🚀 ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "▪️↓  ارسل لي رابط الدعم الان🎐", 1, "md")
          end
          database:setex("bot:support:link" .. msg.sender_user_id_, 120, true)
        end
        if is_sudo(msg) and (text:match("^[Dd]elsupport$") or text:match("^حذف رابط الدعم$")) then
          if database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "✸↓  Support *Information* Deleted 🚀 ", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "✸↓  تم حذف رابط الدعم بنجاح🏌️", 1, "md")
          end
          database:del("bot:supports:link")
        end
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Ff]eedback$") or text:match("^اريد دعم$")) and check_user_channel(msg) then
          ...
          if database:get("waitforfeedback:" .. msg.chat_id_) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "✱↓ لقد ارسلت طلب قبل قليل حاول حاول مره ثانيه في\n " .. time .. "❗️ ", 1, "md")
            end
          else
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "∴ You request your *Help* ✞\n∴ If you wish to *Continue* operation, \n send *Your Message*, or send *Number* `0` ✞ ", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "※اذا اردت الدعم ارسل لي رسالتك 🎈\n ٱو \n ※ ارسل لي 0 🏌️", 1, "md")
            end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Ss]upport$") or text:match("^رابط الدعم$")) and check_user_channel(msg) then
          ...
          if link then
            if link:match("https://") then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "✱↓ رابط الدعم :\n" .. link, 1, "html")
              end
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "✱↓ <b>Support Bot ID</b> : @" .. link, 1, "html")
            else
              send(msg.chat_id_, msg.id_, 1, "✱↓ بوت الدعم : @" .. link, 1, "html")
            end
          elseif database:get("lang:gp:" .. msg.chat_id_) then
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") then
          if (text:match("^[Ss]howedit on$") or text:match("^تفعيل كشف التعديل$")) and check_user_channel(msg) then
            if database:get("sayedit" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "✱↓ Show Edit is already *Activated* ❗️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "✱↓ تم تفعيل كشف التعديل✔", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "✱↓ Show Edit has been *Activated* ❗️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "✱↓ تم تفعيل كشف التعديل ✔", 1, "md")
              end
          ...
          if text:match("^[Ss]howedit off$") or text:match("^تعطيل كشف التعديل$") then
            if not database:get("sayedit" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "✱↓ Show Edit is already *Deactivated* 〽️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "⏺️ تم تعطيل كشف التعديل❓", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "✱↓ Show Edit has been *Deactivated* ⚜️", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "⏺️ تم تعطيل كشف التعديل ♩", 1, "md")
              end
              database:del("sayedit" .. msg.chat_id_)
        ...
        if is_sudo(msg) then
          local text = msg.content_.text_:gsub("ضع كليشه", "Set clerk")
          if text:match("^[Ss]et clerk (.*)$") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "◊↲ تم حفظ الكليشه⇩ :\n\n" .. clerk[2], 1, "html")
            end
          ...
          if text:match("^[Ss]et clerk$") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "◯↲ ارسل لي النص الان🎐", 1, "html")
            end
            database:setex("gettextsec" .. msg.sender_user_id_, 120, true)
          end
          if text:match("^[Dd]el clerk$") or text:match("^حذف الكليشه$") then
            if not database:get("textsec") then
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "💡 Clerk text not *Found* 💡", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "⚜️لا يوجد نص❌", 1, "md")
              end
            else
              if database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "🔅↓  Clerk text has been *Removed* 🎣 ", 1, "md")
              else
                send(msg.chat_id_, msg.id_, 1, "🔅↓ تم حذف النص بنجاح✅", 1, "md")
              end
              database:del("textsec")
            end
          end
          if text:match("^[Gg]et clerk$") or text:match("^جلب الكليشه$") then
            ...
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔹لا يوجد نص 🔹", 1, "md")
            end
          end
        end
...
keeper = "تاج راســكم هذا 🌝🍂"
else 
keeper = ''
end
send(msg.chat_id_, msg.id_, 1, keeper, 1, 'md')
end
if text == 'كرار القيصر' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
keeper = "هذا مطوري وتاج راسي 🌝🍂"
else 
keeper = ''
end
send(msg.chat_id_, msg.id_, 1, keeper, 1, 'md')
...
if text == 'بوت' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
keeper = "شغــال حياتــي لتصيــر دوده وتنشــر روابــط 🌝😹"
else 
keeper = ''
end
send(msg.chat_id_, msg.id_, 1, keeper, 1, 'md')
...
if text == 'احبك' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
keeper =  "حبــك مصحــله مثــل اصدقــاء مطوري🙂🎈"
else 
keeper = ''
end
send(msg.chat_id_, msg.id_, 1, keeper, 1, 'md')
...
if text == '😂😂😂😂' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
keeper =  "براحتك هو انت تطرب ع الضحك 😞😹"
else 
keeper = ''
end
send(msg.chat_id_, msg.id_, 1, keeper, 1, 'md')
...
واحذف حسابك 😹
ﮧ━━━━━━━ﮧ
✺. الرابــط : https://telegram.org/deactivate 
]]
                send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end 
...
🎌⇣ م4 : لعرض اوامر التحويلات 📲

🎌⇣ م5 : لعــرض اوامر الاخرى 🕰️

🎌⇣ م6 : لعرض اوامر المطور 🎎

🎌⇣ م7 : لعرض الاوامر الثانويه 📻
ﮧ━─────────━ﮧ
✸. مــطور 🕵🏻 السورس : @llX8Xll
...
▫️ (قفل\فتح) السيلفي 🖱️
ﮧ---------------------ﮧ
Ⓜ️قفل المجموعه بالوقت : لقفلها بالوقت ⏰
Ⓜ️ فتح المجموعه بالوقت : لفتحها 💾
Ⓜ️ ضع وقت : لوضع وقت قفل المجموعه ⏱️
Ⓜ️ قفل المجموعه + الساعه+ الدقيقه+ الثانيه: 
لقفلها ✔️
Ⓜ️ قفل المجموعه + الساعه + الدقيقه : لقفلها¶
Ⓜ️ قفل المجموعه + الساعه : لقفلها ®
ﮧ━─────────━ﮧ
✸. مــطور 🕵🏻 السورس : @llX8Xll
...
🔖ضع تحذير بالطرد : لوضع التحذير بالطرد 💸
...
✱- طرد : لطرد العضو ⚜️
◊- كتم + ساعه +الدقيقه+ الثانيه :-
لكتم العضو بالوقت ♩
ﮧ━━━━━━━━━ﮧ
〖 اوامر المسح √〗 :-

✱-  مسح الادمنيه : لحذف الادمنه 🎐
✱- مسح المكتومين: لحذف المكتومين ⚜️
✰- مسح البوتات : لطرد البوتات 🎈
☆- مسح الاعضاء : لطرد الاعضاء ☑️
☆- مسح الحسابات المحذوفه: 
لطرد الحسابات المحذوفه في المجموعه 💭
※- مسح المحظورين : لمسح المحظورين 🕴️
※- مسح قائمه العام : لتنضيف المحظورين 🎽
※- مسح قائمه المنع : لتنضيف الكلمات الممنوعه🎫
✯- مسح المدراء : لمسح المدراء ♩
✯- مسح الاعضاء المميزين : لمسحهم ✔
✯- مسح ادمنيه البوت : لمسح الادمنيه 🛋️
✪- مسح حظر المجموعه: لمسح المحظورين او اضافتهم 🎯
✪- مسح الرسائل : لمسح الرسائل 📃
...
ﭑهلإ بــك في سورس *KEEPER*🏌️
ﮧ━─────────━ﮧ
※ الآوامر التحويلات  كتالي:- 

▪ ملصق بالرد ع الصوره:-
لتحويل الصوره الى ملصق 🗺️

▪️ صوره بالرد ع الملصق :- 
لتحويل الملصق الى صوره📠

▪️love + كلمتين بالغه الانكليزيه:-
صنع ملصق باسمك 🎭
...
▪️قائمه العام : لعرض المحظورين عام ☑️
▪ ادمنيه البوت : لعرض ادمنيه البوت📛
▪️المطورين : لعرض المطوريــن 📍
...
لٱلغاء الامر اكتب */cancel*

▫️ ارسال توجيه:- ثم ارسل النص او اجلب توجيه 
للنص   لٱرسالۿ  لٱلغائه اكتب */cancel*📥
...
▫️جلب صوره +العدد : لجلب صوره حسابك 📷
...
▫️ ضع كليشه : لوضع كليشه للبوت 🤘🏿 •

🔹 الكليشه مفعله : لتفعيل اضهار الكليشةه 🌪 •
🔹 الكليشه معطله : لتعطيل اضهار الكليشةه 📃 •

🔸 مميزات البوت مفعله : لتفعيل المميزات 🔉 •
🔸 مميزات البوت معطله : لتعطيل المميزات 📊 •

▫️ الدخول عبر الرابط مفعل : لتفعيلةه ⚙️ •
▫️ الدخول عبر الرابط معطل : لتعطيلةه 💭 •
ﮧ━─────────━ﮧ
✸. مــطور 🕵🏻 السورس : @llX8Xll
...
🔸 *h* : لعرض اوامر الحمايه

🔸 *h2* : لعرض اوامر الرفع 

🔸 *h3* : لعرض اوامر الحضر 

🔸 *h4* : لعرض الاوامر الاخرى
━─────────━
✸. *sudo source* : @llX8Xll
]]
                send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
...
ﭑهلإ بــك في سورس *KEEPER*🏌️
ﮧ━─────────━ﮧ
※ الآوامر الثانويه كالتالــــي : - 
🔸 وضع مذكره : لوضع مذكره ✅
🔸 المذكره : لعرضها 🚏
🔸 ضع رابط : لوضع رابط ♻️
🔸 الرابط : لعرض الرابط ◀️

▪️ حذف الرابط : لحذفه ✔
▪️ ضع رابط الدعم : لوضع رابط للدعم ✞
▪️ حذف رابط الدعم : لحذفه ✔
▪️ رابط الدعم : لعرضه 🎏

▫️ اريد دعم : لطلب دعم من المطور 🏷️
▫️ معلومات البوت : لعرض معلوماته ™️
▫️ تحديث المعلومات : لتحديثها 🛐
...
� حسابه + الايدي : لعرض حساب العضو †
� وقت الاذان+اسم المدينه : لعرضه ✔
...
✸. مــطور 🕵🏻 السورس : @llX8Xll
  ...
  if text:match("^h3$") and is_momod(msg.sender_user_id_, msg.chat_id_) then
...
✸. *sudo source* : @llX8Xll
                ...
                send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
				 ...
				 if text:match("^h$") and is_momod(msg.sender_user_id_, msg.chat_id_) then
...
✸. *sudo source* : @llX8Xll
 ...
 if text:match("^h4$") and is_momod(msg.sender_user_id_, msg.chat_id_) then
...
✸. *sudo source* : @llX8Xll
  ...
  if text:match("^h2$") and is_momod(msg.sender_user_id_, msg.chat_id_) then
...
if text:match("^المطور$") or text:match("^مطور السورس$") then
...
if text:match("^اريد قناة يوتيوب$") or text:match("^قناة يوتيوب$") or text:match("^قناة فيسبوك$") or  text:match("^حسابي تعطل$") or text:match("^اريد متاح$") then
...
https://m.youtube.com/c/alo0ohs
 ...
 local welcome = {string.match(text, "^(وضع ترحيب) (.*)$")}
	...
	if wel then
         ...
         send(msg.chat_id_, msg.id_, 1, '🔸 لا يوجد ترحيب في المجموعــۿ ⚜️', 1, 'md')
end
	end
end
...
`
            ...
            send(msg.chat_id_, msg.id_, 1, "⇗معلومات حول البوت⇖ \n\n◊↲ المجموعات : " .. gps .. "\n\n◊↲ الرسائل  : " .. allmgs .. "\n\n◊↲ الوقت : " .. Uptime .. "\n\n◊↲ الخروج التلقائي : " .. autoleavefa .. "\n\n◊↲ الكليشه : " .. clerkfa .. "\n\n◊↲  الدخول للقناة : " .. joinchannelfa .. "\n\n◊↲ المميزات الجديده : " .. funfa .. "\n\n◊↲  المشاهده : " .. markreadfa .. "\n\n◊↲  الدخول عبر الرابط : " .. joinbylinkfa .. "\n\n◊↲ حفظ الرقم : " .. savecontfa .. "\n\n☜معلومات السيرفر☞ :\n\n⇦ يوزر : " .. usersv .. "\n\n⇦ وقت التشغيل : " .. ResultUptimeServer .. [[
        ...
        if is_sudo(msg) and (text:match("^[Rr]esgp$") or text:match("^تحديث المجموعات$")) then
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "◊↲ تم تحديث عدد المجموعات📍 ", 1, "md")
          end
          database:del("bot:groups")
        end
        if is_sudo(msg) and (text:match("^[Rr]esmsg$") or text:match("^تحديث الرسائل$")) then
          ...
          if database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "◊↲  تم تحديث ✅ جميع الرسائل📍 ", 1, "md")
          end
        end
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Ss]etlang (.*)$") or text:match("^ضع لغه (.*)$")) then
          ...
          if langs[2] == "ar" or langs[2] == "عربي" then
            if not database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "➢ تم تغير الغه عربي🎣", 1, "md")
            else
              send(msg.chat_id_, msg.id_, 1, "➢ تم تغير الغه للعربيه🎐 ", 1, "md")
          ...
          if text:match("^[Ll]ock auto$") and check_user_channel(msg) then
            ...
            if not s and not t then
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "💠↓  ارسل لي بدايه ونهاية الوقت\n\nكذالك وقت فتح المجموعه\nمثلاً : 12:23 🎈",  1, "md")
              end
          ...
          if database:get("bot:SetMuteall:start" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) and text:match("^%d+:%d+$") then
            ...
            if h_ >= tonumber(h) and m_ >= tonumber(m) then
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "💠↓  ارسل لي نهايه الوقت الان 📍 \nمثلا  : 10:47", 1, "md")
              end
            ...
            if text:match("^%d+:%d+") and not text:match(t) then
              ...
              if h_ >= tonumber(h) and m_ >= tonumber(m) then
                ...
                if database:get("lang:gp:" .. msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, "✱↓  تم قفل المجموعه من :\n الساعه :  " .. start .. "⏱️\n الى الساعه : " .. stop .. " 🎐", 1, "md")
                end
          ...
          if text:match("^[Uu]nlock auto$") and check_user_channel(msg) then
            if database:get("bot:muteall:Time" .. msg.chat_id_) then
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "💠↓  تم ✅ فتح المجموعه بالوقت✨🎈 ", 1, "md")
              end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") then
          ...
          if text:match("^[Ss]ettime$") and check_user_channel(msg) then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "💠↓  ارسل لي وقت بدايه القفل \n\nكذالك وقت فتح المجموعه\nمثلاً : 12:23 🎈 ", 1, "md")
            end
          end
        end
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ll]ock gtime (%d+) (%d+) (%d+)$") and check_user_channel(msg) then
          ...
          if 1 <= matches[1] + matches[2] + matches[3] then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "💠↓  تم قفل الكل خلال:\n " .. matches[1] .. "ساعه و " .. matches[2] .. " دقیقه و \n " .. matches[3] .. " 🏌️", 1, "md")
            end
          elseif database:get("lang:gp:" .. msg.chat_id_) then
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and text:match("^[Ll]ock gtime (%d+) (%d+)$") and check_user_channel(msg) then
          ...
          if 1 <= matches[1] + matches[2] then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "💠↓  تم قفل المجموعه خلال:\n " .. matches[1] .. " ساعه و " .. matches[2] .. " دقيقه🎋", 1, "md")
            end
          elseif database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "⇛ Please *Use* a Number Greater Than 0 ✞", 1, "md")
          else
        ...
        if database:get("bot:gtime:say2") then
          ...
          if gtimeTime_ < 5 then
            if database:get("lang:gp:" .. gtimeChat_) then
              ...
              send(gtimeChat_, 0, 1, "◊↲  انتهى وقت قفل المجموعه🎈\nيمكن ارسال الرسائل الان🎐", 1, "md")
            end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Cc]lean (.*)$") or text:match("^مسح (.*)$"))  and check_user_channel(msg) then
          ...
          if txt[2] == "banlist" or txts[2] == "المحظورين" and idf:match("-100(%d+)") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓ تم √ مسح المحظورين🎋", 1, "md")
            end
          end
          if is_sudo(msg) and (txt[2] == "banalllist" or txts[2] == "قائمه العام") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓ تم √ مسح المحظورين عام♩", 1, "md")
            end
          end
          ...
          if txt[2] == "deleted" or txts[2] == "الحسابات المحذوفه" and idf:match("-100(%d+)") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم √ طرد جميع الحسابات المحذوفه🎋", 1, "html")
            end
          end
          if txt[2] == "blocked" or txts[2] == "حظر المجموعه" and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓ اهــــــــلاً عزيزي ...؟🕵🏻\n\n✱↓اذا اردت مسح المحضورين في المجموعه ارسل لي رقم 1\n\n✱↓ اذا اردت اضافتهم للمجموعه ارسل لي رقم 2 🎋❗️",  1, "md")
            end
            database:setex("CleanBlockList" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 35, true)
          end
          if is_sudo(msg) and (txt[2] == "members" or txts[2] == "الاعضاء" and idf:match("-100(%d+)")) then
            do
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "🔖↓  تم✅ طرد الاعضاء 🎋🎈", 1, "html")
              end
            end
          else
          end
          if txt[2] == "bots" or txts[2] == "البوتات" and idf:match("-100(%d+)") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم ✔ مسح البوتات ♬♩", 1, "md")
            end
          ...
          if txt[2] == "ownerlist" or txts[2] == "المدراء" and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم ✅ مسح المدراء 🏌️", 1, "md")
            end
          ...
          if is_leader(msg) and (txt[2] == "sudolist" or txts[2] == "المطورين") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم √ مسح كل المطورين 🕵🏽📍 ", 1, "md")
            end
            local hash = "Bot:SudoUsers"
            local list = database:smembers(hash)
            for k, v in pairs(list) do
          ...
          if is_leader(msg) and (txt[2] == "adminlist" or txts[2] == "ادمنيه البوت") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم ✅ مسح ادمنية البوت 📍 ", 1, "md")
            end
          ...
          if txt[2] == "viplist" or txts[2] == "الاعضاء المميزين" and idf:match("-100(%d+)") then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم ✅ مسح الاعضاء المميزين 💔🎈", 1, "md")
            end
          ...
          if txt[2] == "mutelist" or txts[2] == "المكتومين" and idf:match("-100(%d+)") then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "🔖↓  تم √ مسح الممتومين 🎋🎈", 1, "md")
            end
          end
        end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") then
          if (text:match("^[Ss]etrules$") or text:match("^ضع قوانين$")) and check_user_channel(msg) then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "● ◄  ارسل القوانين الان 📤", 1, "md")
            end
          end
          if (text:match("^[Dd]elrules$") or text:match("^مسح القوانين$")) and check_user_channel(msg) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "● ◄  تم مسح القوانيــن 📬", 1, "md")
            end
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and idf:match("-100(%d+)") and (text:match("^[Rr]ules$") or text:match("^القوانين$")) then
          ...
          elseif database:get("lang:gp:" .. msg.chat_id_) then
            ...
            send(msg.chat_id_, msg.id_, 1, "🔹 لا توجد قوانين 🎌",  1, "md")
          end
        end
        ...
        if is_admin(msg.sender_user_id_) and text:match("^[Ll]eave(-%d+)$") or text:match("^غادر(-%d+)$")  then
          ...
          local leavegp = function(extra, result)
            if result.id_ then
              send(msg.chat_id_, msg.id_, 1, "✸ المجموعــۿ  " .. result.title_ .. "\n\n↲ تم اخراج البوت منها", 1, "md")
        ...
        if is_admin(msg.sender_user_id_) and idf:match("-100(%d+)") and text:match("^[Aa]dd$") or text:match("^تفعيل$") then
          local adding = function(extra, result)
            ...
            if database:get("bot:enable:" .. msg.chat_id_) then
              if not database:get("lang:gp:" .. msg.chat_id_) then
                send(msg.chat_id_, msg.id_, 1, "✿↲ اِّهُِــــــــلاً مُــــــُٰــطٰٰورٰٰي 🎭  " .. (chat and chat.title_ or "") .. "\n\n✿↲  المُٰـٰٰـجمَوعـٰٰــه 🚩 مفـٰٰعٰٰــلْهّٰ 📍 ", 1, "md")
              else
...
If you *want* to get the bot phone number , send command *Botphone* .]], 1, "md")
              ...
              send(bot_owner, 0, 1, "◯↲ *تم اضافه مجموعه جديده*\n\n�⇣ التاريخ : " .. Time().date .. "\n�⇣ الساعه : " .. Time().time .. "\n\n�⇣ ايدي  : <code>" .. msg.sender_user_id_ .. "</code>\n�⇣ الاسم : " .. fname .. " " .. lname .. "\n�⇣ المعرف : " .. username .. "\n\n➢ ايدي المجموعه : <code>" .. msg.chat_id_ .. "</code>\n➢ اسم المجموعه : " .. (chat and chat.title_ or "----") .. "\n\n➢ لاخراج البوت ارسل الامر التالي : \n\n••  <code>leave" .. msg.chat_id_ .. "</code>", 1, "html")
              database:set("bot:enable:" .. msg.chat_id_, true)
        ...
        if is_admin(msg.sender_user_id_) and idf:match("-100(%d+)") and text:match("^[Rr]em$") or text:match("^تعطيل$") then
          ...
          if not database:get("bot:enable:" .. msg.chat_id_) then
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "✿↲ اِّهُِــــــــلاً مُــــــُٰــطٰٰورٰٰي 🎭  " .. (chat and chat.title_ or "") .. "\n\n✿↲  المُٰـٰٰـجمَوعـٰٰــه 🚩 مُعطــلهِّ 📍 ", 1, "md")
            end
          else
            if database:get("lang:gp:" .. msg.chat_id_) then
        ...
        if is_admin(msg.sender_user_id_) and idf:match("-100(%d+)") and text:match("^[Rr]em(-%d+)$") or text:match("^تعطيل(-%d+)$") then
          do
            ...
            local send_to_bot_owner = function(extra, result)
              ...
              send(v, 0, 1, "➢ تم ازالة المجموعه✞\n\n↲ التاريخ : " .. Time().date .. "\n↲ الوقت : " .. Time().time .. "\n↲ الاسم : " .. fname .. " " .. lname .. "\n • المعرف : " .. username .. "\n• ايدي المجموعه : <code>" .. gp[2] .. "</code>", 1, "html")
          ...
          local get_data = function(extra, result)
            if result.id_ then
              if is_admin(result.id_) then
                ...
                send(msg.chat_id_, msg.id_, 1, "✸↓  العضو ليس من المطورين📍 ", 1, "html")
              end
            else
              send(msg.chat_id_, msg.id_, 1, "✸↓  العضو ليس من المطورين📍 ", 1, "html")
            end
        ...
        if (idf:match("-100(%d+)") or is_momod(msg.sender_user_id_, msg.chat_id_)) and text:match("^[Mm]e$") and msg.reply_to_message_id_ == 0 and check_user_channel(msg) then
          local get_me = function(extra, result)
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "▫️↓  User : " .. username .. "\n▪️↓   <b>Your ID</b> : <code>" .. result.id_ .. "</code>\n▫️↓  <b>Your Rank</b> : <b>" .. ten .. "</b>", 1, "html")
            else
              send(msg.chat_id_, msg.id_, 1, "▫️↓  العضو : " .. username .. "\n\n▪️↓   الايدي : " .. result.id_ .. "\n\n※  الرتبۿ : " .. tfa, 1, "html")
            end
          end
          getUser(msg.sender_user_id_, get_me)
        end
        if (idf:match("-100(%d+)") or is_momod(msg.sender_user_id_, msg.chat_id_)) and text:match("^شنو اني$") and msg.reply_to_message_id_ == 0 and check_user_channel(msg) then
          local get_me = function(extra, result)
            if tonumber(result.id_) == tonumber(karrar) then
              ten = "مطور السورس"
              tfa = "--"
          ...
          local idinfocallback = function(extra, result)
            if result.first_name_ then
              ...
              if database:get("lang:gp:" .. msg.chat_id_) then
                ...
                sendmen(msg.chat_id_, msg.id_, "✪↓  اضغــط هنا عزيــزي 🎐", 2, 33, result.id_)
              end
            elseif database:get("lang:gp:" .. msg.chat_id_) then
              send(msg.chat_id_, msg.id_, 1, "➢ *User Not Found* ✞ ", 1, "md")
            else
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and text:match("^حسابه (%d+)$") and check_user_channel(msg) then
          local apfa = {
            string.match(text, "^(حسابه) (%d+)$")
          }
        ...
        if is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Tt]ime$") or text:match("^الوقت$")) and check_user_channel(msg) then
          local url, res = https.request("https://irapi.ir/time/")
          if res == 200 then
            local jdat = json.decode(url)
            if jdat.FAtime and jdat.FAdate and jdat.ENtime and jdat.ENdate then
              local a = "✱ الساعه : " .. jdat.FAtime .. "\n✱ التاريخ : " .. jdat.FAdate .. "\n"
        ...
        if (database:get("fun") == "On" or is_admin(msg.sender_user_id_)) and is_momod(msg.sender_user_id_, msg.chat_id_) then
          ...
          if text:match("^[Pp]raytime (.*)$") and check_user_channel(msg) then
            ...
            local textfa = "🔹 المديــنۿ: " .. city
            textfa = textfa .. "\n\n※  اذان الصبح 🎖 : " .. data.Fajr
            ...
            texten = texten .. "\nⓂ️ Fajr : " .. data.Fajr
            texten = texten .. "\nⓂ️ Sunrise : " .. data.Sunrise
            texten = texten .. "\nⓂ️ Dhuhr : " .. data.Dhuhr
            texten = texten .. "\nⓂ️ Sunset : " .. data.Sunset
            texten = texten .. "\nⓂ️ Maghrib : " .. data.Maghrib
            texten = texten .. "\nⓂ️ Isha : " .. data.Isha
            texten = texten .. [[
        ...
        if (database:get("fun") == "On" or is_admin(msg.sender_user_id_)) and is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Tt]osticker$") or text:match("^ملصق$")) and check_user_channel(msg) then
          ...
          elseif not database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "● ◄  استخدم الامر بالرد ع الصوره📸", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "● ◄  Please *Reply On a Photo* And Then Send This Command 📍 ", 1, "md")
          end
        end
        if (database:get("fun") == "On" or is_admin(msg.sender_user_id_)) and is_momod(msg.sender_user_id_, msg.chat_id_) and (text:match("^[Tt]ophoto$") or text:match("^صوره$")) and check_user_channel(msg) then
          if msg.reply_to_message_id_ ~= 0 then
          ...
          elseif not database:get("lang:gp:" .. msg.chat_id_) then
            send(msg.chat_id_, msg.id_, 1, "● ◄  استخدم الامر بالرد ع الملصق 🕯️", 1, "md")
          else
            send(msg.chat_id_, msg.id_, 1, "● ◄  Please *Reply On a Sticker* And Then Send This Command 📍 ", 1, "md")
          end
        end
        if (database:get("fun") == "On" or is_admin(msg.sender_user_id_)) and is_momod(msg.sender_user_id_, msg.chat_id_) then
          text = text:gsub("صنع متحركه", "Gif")
        ...
        if (database:get("fun") == "On" or is_admin(msg.sender_user_id_)) and is_momod(msg.sender_user_id_, msg.chat_id_) and text:match("^[Kk][Ee][Ee][Pp][Cc][Aa][Ll][Mm] (.*) (.*) (.*) (.*) (.*)$") and check_user_channel(msg) then
          ...
          if is_leader(msg) and text:match("^[Rr]estart$") or text:match("^مسح بيانات البوت$")  then
            ...
            if database:get("lang:gp:" .. msg.chat_id_) then
              ...
              send(msg.chat_id_, msg.id_, 1, "▪️↓   هل تريد مسح بيانات البوت:\n\n✸ ارسل لي رقم 1 للموافقه🎌\n\n� ارسل لي رقم 0 للخروجمن الامر🎐 ", 1, "md")
            end
